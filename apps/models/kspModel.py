...
class komplain(models.Model):
    ...
    sekolah = models.ForeignKey(master, on_delete=models.CASCADE, related_name="komplain", null=True, blank=True)
...
class saran(models.Model):
    ...
    sekolah = models.ForeignKey(master, on_delete=models.CASCADE, related_name="saran")
...
class permintaan(models.Model):
    ...
    sekolah = models.ForeignKey(master, on_delete=models.CASCADE, related_name="permintaan")
